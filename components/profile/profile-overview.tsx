    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="cursor-pointer" onClick={() => router.push("/dashboard")}>
          ...
          <CardContent>
            <p className="text-3xl font-bold text-primary"> ₹{wallet ? wallet.balance : "0.00"}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <Button
          variant="destructive"
          className="h-auto py-4 flex flex-col items-center justify-center gap-2 col-span-1 sm:col-span-2 md:col-span-5 mt-4 mb-10"
